      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-regal-offwhite dark:bg-regal-offBlack p-4 rounded-xl text-center">
          ...
          <p className="text-black  dark:text-white">
            Developed a Fruit Ecommerce frontend system using ReactJS, Material
            UI, and Context API with state management handled by Redux Toolkit,
        ...
        <div className="bg-regal-offwhite dark:bg-regal-offBlack  p-4 rounded-xl text-center ">
          ...
          <p className="text-black  dark:text-white">
            Implemented Figma to Bootstrap conversion for a responsive astrology
            website with user-friendly UI Transformed Figma prototypes into a
            responsive Bootstrap-based astrology website with seamless user
            experience
          </p>
        </div>
